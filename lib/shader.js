...
var Shader = function () {
  ...
  function Shader(vertexSource, fragmentSource) {
    ...
    if (webGlPrecision !== 'highp') {
      fragmentSource = fragmentSource.replace(/precision highp float/g, 'precision ' + webGlPrecision + ' float');
    }
  ...
  _createClass(Shader, [{
    key: 'precisionSupported',
    value: function precisionSupported() {
      var canvas = document.createElement('canvas');
      var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl');
      var supportedPrecision = void 0;
      if (gl) {
    ...
    key: 'testPrecision',
    value: function testPrecision(gl, precision) {
